...
public partial class App : Application
{
	...
	protected override void OnStartup(StartupEventArgs e)
	{
		...
		services.AddScoped<IMailService>(mail => new MailService("smtp.mail.ru", 587, Environment.GetEnvironmentVariable("MAIL"), Environment.GetEnvironmentVariable("MAIL_PASSWORD")));
